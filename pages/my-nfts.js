...
export default function MyAssets() {
  ...
  className='px-20 py-7 text-4x1 font-bold text-white'>You do not own any NFTs currently :(</h1>)

  return (
    <div>
    <h1 style={{fontSize:'20px', color:'yellow' ,padding:'20px 0'}}>My NFT</h1>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4'>
          {
              nfts.map((nft, i) => (
                ...
                <div key={i} className='border shadow rounded-xl overflow-hidden'>
                  ...
                  <div className='p-4 bg-black'>
                    <p className='bg-slate-800 py-4	text-3x-1 mb-4 font-bold text-yellow bg-transparent	'>{nft.price} ETH</p>
